...
import ViewAllVehicle from "../viewAllVehicle/viewAllVehicle.jsx";
import AddNewVehicle from "../addNewVehicle/addNewVehicle.jsx";
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <AppBar position="fixed" open={open} sx={{backgroundColor:'#1F1F1F'}}>
                <Toolbar>
                    <Typography variant="h6" noWrap component="div" sx={{fontWeight:'bold', color:'#FF7200'}}>
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <Box>
                    <Routes>
                        {getRoutes(routes)}
                        <Route path={'*'} element={<Navigate to={'/viewAllVehicle'}/>}/>
                    </Routes>
                </Box>
            </Box>
        </Box>
